...
W("""
INSERT INTO res_partner (name, ref, street, zip, phone, is_company, active, customer_rank, health_state, create_date, write_date, create_uid, write_uid, company_id, commercial_partner_id, display_name, complete_name)
SELECT t.nom, 'ORA-'||t.num, t.street, t.zip, t.phone, t.is_co, TRUE, 1, 'ok', NOW(), NOW(), 1, 1, NULL, NULL, t.nom, t.nom
